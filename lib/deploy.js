...
var shallowMerge = require('./util/object').shallowMerge;
...
var deployProject = function(directory, done) {
    ...
    var checkDirectory = function checkDirectory(callback) {
    ...
    var installBuild = function installBuild(input, callback) {
        if (directory === 'public') {
            async.waterfall([
                npm.checkInstall,
                npm.runBuild
